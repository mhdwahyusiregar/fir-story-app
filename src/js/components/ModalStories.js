...
class ModalStories extends LitWithoutShadowDom {
  static properties = {
      ...
      <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3">
              <img src="" id="imgDetailRecord" class="img-fluid" alt="Evidence of stories" />
            </div>
...
customElements.define('modal-stories', ModalStories);
